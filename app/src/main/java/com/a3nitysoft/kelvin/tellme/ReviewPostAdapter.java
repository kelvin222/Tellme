...
public class ReviewPostAdapter extends RecyclerView.Adapter<ReviewPostAdapter.MessageViewHolder>{
    ...
    public ReviewPostAdapter(List<RevPost> blog_list) {
    ...
    public void onBindViewHolder(final MessageViewHolder holder, int position) {
        ...
        holder.revsView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                newIntent.putExtra("ruserId", user_id);
        ...
        FirebaseDatabase.getInstance().getReference().child("comments/" + revPostId)
